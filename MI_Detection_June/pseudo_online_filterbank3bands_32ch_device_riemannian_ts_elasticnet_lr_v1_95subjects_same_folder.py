...
3-band Filter-bank Riemannian Tangent Space + Elastic-Net Logistic Regression, model benchmark v1.
...
-------------------
python -u pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects.py > "D:\BCI\EEGBCI_Results\filterbank3bands_32ch_device_ts_elasticnet_lr_v1_95subjects_run.log" 2>&1

Expected outputs
----------------
<script folder>\pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects_results.json
<script folder>\pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects_results_selected_configs.csv
D:\BCI\EEGBCI_Results\pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects_subject<ID>.json
...
ELASTIC_NET_C_LIST = [0.01, 0.1, 1.0]
...
def run_one_subject(data_dir, subject_id):
    print("=" * 80)
    print(f"Pseudo-online 3-band FilterBank Riemannian TS-ElasticNetLR v1 | subject {subject_id}")
    print(f"RUNS               = {RUNS}")
    print(f"BANDS              = {BANDS}")
    ...
    for test_run in RUNS:
        ...
        fold_summary = {
            ...
            "selection_status": f"loro_inner_run_validation_filterbank_riemannian_ts_elasticnet_lr_v1_3bands::{selection_meta['selection_mode']}",
            "best_validation_config": {
                ...
                "probability_output": "cv_sigmoid_calibrated_elasticnet_lr_decision_function" if USE_SIGMOID_CALIBRATION else "elasticnet_lr_predict_proba_no_extra_calibration",
...
def main():
    ...
    for subject_id in SUBJECT_IDS:
        ...
        subj_json = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects_subject{subject_id}.json"
    ...
    overall = {
        "model": "PseudoOnline_FilterBank3Bands_32ChDevice_Riemannian_TangentSpace_ElasticNetLR_MIvsRest_LORO_V1_95Subjects",
    ...
    overall["selection_policy"] = {
        "strategy": "balanced_robust_filterbank3bands_riemannian_ts_elasticnet_lr_v1",
        "target_max_inner_val_far": TARGET_MAX_INNER_VAL_FAR,
        "target_max_inner_val_far_std": TARGET_MAX_INNER_VAL_FAR_STD,
        "target_min_inner_val_hit": TARGET_MIN_INNER_VAL_HIT,
        "fixed_refractory_sec": FIXED_REFRACTORY_SEC,
    ...
    out_json = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects_{suffix}.json"
    with open(out_json, "w", encoding="utf-8") as f:
        json.dump(overall, f, indent=2, ensure_ascii=False)

    out_csv = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects_{suffix}_selected_configs.csv"
    if csv_rows:
    ...
    if subject_errors:
        out_err = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_elasticnet_lr_v1_95subjects_{suffix}_subject_errors.json"
    ...
    print("=" * 80, flush=True)
    print("Finished 3-band 32-channel device-layout FilterBank Riemannian TS-ElasticNetLR v1 95-subject benchmark", flush=True)
