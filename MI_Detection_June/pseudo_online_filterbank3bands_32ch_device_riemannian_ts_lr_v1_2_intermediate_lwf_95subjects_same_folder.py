...
v1.2 intermediate decision layer, covariance-estimator ablation (Ledoit-Wolf).
...
- Feature/model: Ledoit-Wolf covariance -> Riemannian Tangent Space -> L2 LR
...
Suggested folder: D:\BCI\FBCSPNet\June\June8-12\03

Run
---
python -u pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_same_folder.py > lwf_95subjects_run.log 2>&1

Expected outputs beside this script
-----------------------------------
pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_results.json
pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_results_selected_configs.csv
pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_subject<ID>.json
...
def run_one_subject(data_dir, subject_id):
    ...
    for test_run in RUNS:
        ...
        for val_run in dev_runs:
            ...
            for tmin, tmax in fold_search_space["train_windows"]:
                ...
                for model_idx, (lr_c, l1_ratio) in enumerate(itertools.product(
                    ...
                    print(
                        f"Training FilterBank Riemannian TS+LR (lwf) | subj={subject_id} "
        ...
        print(
            f"Training FINAL FilterBank Riemannian TS+LR (lwf) | subj={subject_id} "
        ...
        fold_summary = {
            ...
            "selection_status": f"loro_inner_run_validation_filterbank_riemannian_ts_lr_v1_2_intermediate_lwf_3bands::{selection_meta['selection_mode']}",
...
def main():
    ...
    for subject_id in SUBJECT_IDS:
        ...
        subj_json = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_subject{subject_id}.json"
    ...
    overall = {
        "model": "PseudoOnline_FilterBank3Bands_32ChDevice_Riemannian_TangentSpace_LR_LWFCov_MIvsRest_LORO_V1_2Intermediate_95Subjects",
    ...
    overall["selection_policy"] = {
        "strategy": "balanced_robust_filterbank3bands_riemannian_ts_lr_v1_2_intermediate_lwf",
        "target_max_inner_val_far": TARGET_MAX_INNER_VAL_FAR,
        "target_max_inner_val_far_std": TARGET_MAX_INNER_VAL_FAR_STD,
        "target_min_inner_val_hit": TARGET_MIN_INNER_VAL_HIT,
        "fixed_refractory_sec": FIXED_REFRACTORY_SEC,
    ...
    out_json = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_{suffix}.json"
    with open(out_json, "w", encoding="utf-8") as f:
        json.dump(overall, f, indent=2, ensure_ascii=False)

    out_csv = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_{suffix}_selected_configs.csv"
    if csv_rows:
    ...
    if subject_errors:
        out_err = output_dir / f"pseudo_online_filterbank3bands_32ch_device_riemannian_ts_lr_v1_2_intermediate_lwf_95subjects_{suffix}_subject_errors.json"
    ...
    print("=" * 80, flush=True)
    print("Finished 3-band 32-channel device-layout TS+LR v1.2 Ledoit-Wolf covariance 95-subject benchmark", flush=True)
